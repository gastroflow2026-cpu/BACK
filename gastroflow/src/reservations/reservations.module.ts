...
@Module({
    imports: [TypeOrmModule.forFeature([Reservation, Restaurant, RestaurantTables, User, ReservationPayment])],
    controllers: [ReservationsController],
    providers: [ReservationsService, ReservationsRepository, RestaurantTablesRepository, ReservationsPaymentService]
})
